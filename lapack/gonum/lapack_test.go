...
func TestDggbak(t *testing.T) {
	t.Parallel()
	testlapack.DggbakTest(t, impl)
}
...
func TestDgeesSort(t *testing.T) {
	t.Parallel()
	testlapack.DgeesSortTest(t, impl)
}
...
func TestDtgsen(t *testing.T) {
	t.Parallel()
	testlapack.DtgsenTest(t, impl)
}
