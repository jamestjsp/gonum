...
func (Implementation) Srotm(n int, x []float32, incX int, y []float32, incY int, p blas.SrotmParams) {
	...
	case blas.Rescaling:
		...
		if incX == 1 && incY == 1 {
			...
			f32.RotmUnitaryRescaling(x[:n], y[:n], h11, h12, h21, h22)
			return
		}
		var ix, iy int
		if incX < 0 {
	...
	case blas.OffDiagonal:
		...
		if incX == 1 && incY == 1 {
			...
			f32.RotmUnitaryOffDiagonal(x[:n], y[:n], h12, h21)
			return
		}
		var ix, iy int
		if incX < 0 {
	...
	case blas.Diagonal:
		...
		if incX == 1 && incY == 1 {
			...
			f32.RotmUnitaryDiagonal(x[:n], y[:n], h11, h22)
			return
		}
		var ix, iy int
		if incX < 0 {
