...
# The parallel GEMV helper only accepts float64 slices; keep Sgemv serial.
echo Generating level2float32.go
echo -e '// Code generated by "go generate gonum.org/v1/gonum/blas/gonum”; DO NOT EDIT.\n' > level2float32.go
cat level2float64.go \
| sed '/Form y = alpha \* A \* x + y\. Use the row-block parallel path/,/for strided x\/y\./c\
\	// Form y = alpha * A * x + y' \
| sed '/if incX == 1 && incY == 1 && m\*n >= dgemvParallelThreshold {/,/^[[:space:]]*}/d' \
